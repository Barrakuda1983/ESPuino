	...
	*/
	...
	constexpr const char accessPointNetworkSSID[] PROGMEM = "Maloubox";     // Access-point's SSID
	...
	// Bluetooth
	constexpr const char nameBluetoothSinkDevice[] PROGMEM = "Maloubox";        // Name of your ESPuino as Bluetooth-device
